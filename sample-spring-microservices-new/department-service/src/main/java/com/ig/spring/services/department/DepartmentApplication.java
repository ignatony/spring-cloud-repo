package com.ig.spring.services.department;
...
import com.ig.spring.services.department.model.Department;
import com.ig.spring.services.department.repository.DepartmentRepository;
...
public class DepartmentApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.ig.spring.services.department.controller"))
