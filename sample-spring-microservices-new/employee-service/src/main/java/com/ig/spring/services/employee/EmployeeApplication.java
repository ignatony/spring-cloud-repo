package com.ig.spring.services.employee;
...
import com.ig.spring.services.employee.model.Employee;
import com.ig.spring.services.employee.repository.EmployeeRepository;
...
public class EmployeeApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.ig.spring.services.employee.controller"))
